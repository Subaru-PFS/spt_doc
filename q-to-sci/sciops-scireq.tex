...
\begin{itemize}
 ...
 \item An overview presentation of the current status of PFS data
       reduction pipeline by Steve Bickerton (Kavli IPMU): \url{}
...
\begin{enumerate}
 \item[\colm{a}] How do you want to determine field centers and position
          ...
          \end{itemize}
 \item[\colm{b}] Do you need to visit individual fields multiple times?
          If yes:
          \begin{itemize}
           ...
           \item Would you keep the field center and position angle
             for all the visits?
          \end{itemize}
 \item[\colm{c}] Do you need to have an overlap between neighboring
...
\begin{enumerate}
  \item[\coll{a}] Based on what kind of criteria/rules/procedures would
        ...
        \item Priority that is given in advance to individual
              ...
              catalog.
           \end{itemize}
  \item[\coll{b}] If you need to visit single field multiple times, how
           would you want to split objects into subsets for the
           multiple visits and determine fiber allocations?
  \item[\coll{c}] How do you want to split fibers into the targets for
...
%    \end{itemize}
  \item[\coll{d}] What type of objects (stars) would you select as
  ...
  \item[\coll{e}] How would you define ``blank'' sky areas for sky
           fibers? Do you think you can define ``blank'' sky areas
           just based on the information in your master catalog(s)?
  \item[\coll{f}] How do you want to spatially distribute the sky fibers
           in one field?
\end{enumerate}
...
\begin{enumerate}
 \item[\coll{a}] After a fully reduced and calibrated 1D spectrum is extracted,
      what do you want to measure using the spectral features?
 \item[\coll{b}] Could you briefly explain how you will measure them?
      For example:
      \begin{itemize}
      ...
      \end{itemize}
 \item[\coll{c}] Do you think there are any special recipes of data reduction 
 ...
 \item[\coll{d}] The data reduction and calibration follow many steps, so a
...
\begin{enumerate}
 ...
 \item[\coll{e}] The estimation of e.g. S/N by quick DRP is perhaps less
      ...
      when available?
 \item[\coll{f}] Do you think an automatic release of status/progress
...
\begin{enumerate}
 \item[\coll{a}] What kind of survey archive system do you need/want?
